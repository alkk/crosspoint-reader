...
EpdFont lexica10RegularFont(&lexica_10_regular);
EpdFont lexica10BoldFont(&lexica_10_bold);
EpdFont lexica10ItalicFont(&lexica_10_italic);
EpdFont lexica10BoldItalicFont(&lexica_10_bolditalic);
EpdFontFamily lexica10FontFamily(&lexica10RegularFont, &lexica10BoldFont, &lexica10ItalicFont,
                                 &lexica10BoldItalicFont);
...
void setupDisplayAndFonts() {
  ...
  renderer.insertFont(LEXICA_10_FONT_ID, lexica10FontFamily);
