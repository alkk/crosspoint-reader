...
- Bookerly: 10, 12, 14, 16, 18pt (4 styles each: regular, bold, italic, bold-italic)
- Noto Sans: 10, 12, 14, 16, 18pt (4 styles each)
- OpenDyslexic: 8, 10, 12, 14pt (4 styles each)
- Lexica Ultralegible: 10, 12, 14, 16, 18pt (4 styles each: regular, bold, italic, bold-italic)
- Ubuntu UI fonts: 10, 12pt (2 styles)

**Total**: ~103 global `EpdFont` and `EpdFontFamily` objects
